...
*<p>Esta classe fornece operacões matemáticas básicas como soma, subtração,
*multiplicação e divisão, além de um metodo principal que seleciona a operação
*desejada com base em um operador informado pelo usuário.</p>
*<p>Esse projeto ê utilizado para demonstrar:</p>
*<ul>
...
*    <li>Documentacão com Javadoc</11>
*    
*</ul>
...
public class Calculadora {
	...
	/**
	 * 
	 * @param a primeira operando
	 * @param b segunda operando
